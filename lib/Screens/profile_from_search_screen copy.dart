...
import 'package:firebase_login_app/Screens/calender_screen.dart';
...
class ProfilePage1Copy extends StatelessWidget {
  ...
  //   String rate = await avgRates(tutorObject.id) as String;
  //   return rate;
  // }

  @override
  Widget build(BuildContext context) {
    // String rate = avgRates(tutorObject.id) as String;
      ...
      actions: [
        ...
        TextButton(
          onPressed: () {
            ...
            addReview(widget.tutorId, rating, feedback,
                FirebaseAuth.instance.currentUser!.uid
